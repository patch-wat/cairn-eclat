...
## Hit Protection
Roll 1d6 to determine your PC's starting **Hit Protection** (HP), which reflects their ability to avoid damage in combat. HP does not indicate a character's health or fortitude; nor do they lose it for very long (see [**Healing**](/srd/07-Core-Rules.md#healing)). If an attack takes a PC's HP exactly to 0, the player must roll on the [**Scars**](/srd/cairn-srd.md#scars-1) table.
